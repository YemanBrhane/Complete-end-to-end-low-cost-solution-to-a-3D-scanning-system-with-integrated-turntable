#-------------------------------------------------
#
# Project created by QtCreator 2016-11-16T20:23:32
#
#-------------------------------------------------
...
CONFIG += c++11
TARGET = Scanner_3D_GUI
CONFIG += console
CONFIG -= app_bundle
TEMPLATE = app

#For Error: no override found for 'vtkPolyDataMapper
...
# Ardino
INCLUDEPATH += "C:\Qt\Qt5.7.0\5.7\msvc2015_64\include\QtSerialPort"
...
LIBS += "-LC:\VTK-7.0.0\VTK-build\lib\Release"
